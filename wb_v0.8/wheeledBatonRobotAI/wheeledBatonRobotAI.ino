...
/*
 ...
 VERSION: 0.8
 VERSION_NAME: burn-ed rubber: A.K.A. Does this smell like hotdogs?
...
void setup() {
  ...
  Serial.println("version 0.8: 'burn-ed rubber: A.K.A. Does this smell like hotdogs?'");
